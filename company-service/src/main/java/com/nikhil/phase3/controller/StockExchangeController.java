...
public class StockExchangeController {
	...
	public ResponseEntity<List<String>> getAllCompanyExchanges(@PathVariable String companyId){
		return new ResponseEntity<List<String>>(stockExchangeService.getAllCompanyExchanges(companyId), HttpStatus.OK);
	}
}
