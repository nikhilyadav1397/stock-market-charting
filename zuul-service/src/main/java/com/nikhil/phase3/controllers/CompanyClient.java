...
//			@PathVariable LocalDateTime from, @PathVariable LocalDateTime to);
	...
	@GetMapping("/companies/stocks/{companyCode}/{exchange}/{fromDateTime}/{toDateTime}")
